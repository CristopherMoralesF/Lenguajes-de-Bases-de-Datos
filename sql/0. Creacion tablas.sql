...
DROP TABLE TIPO_VALIDACION;
DROP TABLE ASIENTO_LINEA;
DROP TABLE ASIENTO;
DROP TABLE ACTIVO;
DROP TABLE ESTADO;
DROP TABLE CLASE_CUENTA;
DROP TABLE CUENTA_CONTABLE;
DROP TABLE CATEGORIA_CUENTA;
DROP TABLE CLASE;
DROP TABLE USUARIO;
...
INSERT INTO CATEGORIA_CUENTA (DESCRIPCION_CATEGORIA) VALUES ('Complementaria Activo');
...
INSERT INTO CUENTA_CONTABLE VALUES ('6-2-3-167401','Dep Acumulada - Vehiculos',6,0,0,0,'C');
INSERT INTO CUENTA_CONTABLE VALUES ('6-2-3-167402','Dep Acumulada - Edificio',6,0,0,0,'C');
INSERT INTO CUENTA_CONTABLE VALUES ('6-2-3-167403','Dep Acumulada - Maq y Equipo',6,0,0,0,'C');
INSERT INTO CUENTA_CONTABLE VALUES ('6-2-3-167404','Dep Acumulada - Computadoras',6,0,0,0,'C');

INSERT INTO CUENTA_CONTABLE VALUES ('5-2-2-167401','Gasto Depreciación - Vehiculos',5,0,0,0,'D');
INSERT INTO CUENTA_CONTABLE VALUES ('5-2-2-167402','Gasto Depreciación - Edificio',5,0,0,0,'D');
INSERT INTO CUENTA_CONTABLE VALUES ('5-2-2-167403','Gasto Depreciación - Maq y Equipo',5,0,0,0,'D');
INSERT INTO CUENTA_CONTABLE VALUES ('5-2-2-167404','Gasto Depreciación - Computadoras',5,0,0,0,'D');
...
CREATE TABLE CLASE_CUENTA(
    ID_CLASE_CUENTA     INT GENERATED BY DEFAULT ON NULL AS IDENTITY PRIMARY KEY,
    ID_CLASE            INT NOT NULL, 
    ID_CUENTA           VARCHAR2(15) NOT NULL,
...
INSERT INTO CLASE (DESCRIPCION_CLASE,VIDA_UTIL) VALUES ('Vehiculos',10); 
INSERT INTO CLASE (DESCRIPCION_CLASE,VIDA_UTIL) VALUES ('Edificios',25); 
INSERT INTO CLASE (DESCRIPCION_CLASE,VIDA_UTIL) VALUES ('Maquinaria y Equipo',5); 
INSERT INTO CLASE (DESCRIPCION_CLASE,VIDA_UTIL) VALUES ('Computadoras',3); 

SELECT * FROM CLASE_CUENTA;
INSERT INTO CLASE_CUENTA (ID_CLASE,ID_CUENTA,ID_CATEGORIA_CUENTA) VALUES (1,'1-2-2-167401',1); -- Vehiculos
INSERT INTO CLASE_CUENTA (ID_CLASE,ID_CUENTA,ID_CATEGORIA_CUENTA) VALUES (1,'5-2-2-167401',5);
INSERT INTO CLASE_CUENTA (ID_CLASE,ID_CUENTA,ID_CATEGORIA_CUENTA) VALUES (1,'6-2-3-167401',6);
INSERT INTO CLASE_CUENTA (ID_CLASE,ID_CUENTA,ID_CATEGORIA_CUENTA) VALUES (2,'1-2-2-167402',1); -- Edificio
INSERT INTO CLASE_CUENTA (ID_CLASE,ID_CUENTA,ID_CATEGORIA_CUENTA) VALUES (2,'5-2-2-167402',5);
INSERT INTO CLASE_CUENTA (ID_CLASE,ID_CUENTA,ID_CATEGORIA_CUENTA) VALUES (2,'6-2-3-167402',6);
INSERT INTO CLASE_CUENTA (ID_CLASE,ID_CUENTA,ID_CATEGORIA_CUENTA) VALUES (3,'1-2-2-167403',1); -- Maquinaria y Equipo
INSERT INTO CLASE_CUENTA (ID_CLASE,ID_CUENTA,ID_CATEGORIA_CUENTA) VALUES (3,'5-2-2-167403',5);
INSERT INTO CLASE_CUENTA (ID_CLASE,ID_CUENTA,ID_CATEGORIA_CUENTA) VALUES (3,'6-2-3-167403',6);
INSERT INTO CLASE_CUENTA (ID_CLASE,ID_CUENTA,ID_CATEGORIA_CUENTA) VALUES (4,'1-2-2-167404',1); -- Computadoras
INSERT INTO CLASE_CUENTA (ID_CLASE,ID_CUENTA,ID_CATEGORIA_CUENTA) VALUES (4,'5-2-2-167404',5);
INSERT INTO CLASE_CUENTA (ID_CLASE,ID_CUENTA,ID_CATEGORIA_CUENTA) VALUES (4,'6-2-3-167404',6);
...
CREATE TABLE ACTIVO (
    ...
    PERIODOS_DEPRECIADOS    NUMBER(10) DEFAULT 0,
...
UPDATE CUENTA_CONTABLE SET BALANCE = TOTAL_CREDITOS - TOTAL_DEBITOS WHERE ID_CUENTA = '3-1-1-100001';

SELECT * FROM ASIENTO_LINEA;
