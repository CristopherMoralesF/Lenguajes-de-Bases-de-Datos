...
BEGIN
    ...
    -- Select Account
    SELECT ID_CUENTA INTO VAR_ACCOUNT_DEBIT FROM CLASE_CUENTA WHERE ID_CLASE = 1 AND ID_CATEGORIA_CUENTA = 1;
    ...
    -- Debit Account
    UPDATE CUENTA_CONTABLE SET TOTAL_DEBITOS = :NEW.VALOR_ADQUISICION WHERE ID_CUENTA = VAR_ACCOUNT_DEBIT;
    UPDATE CUENTA_CONTABLE SET BALANCE = TOTAL_DEBITOS - TOTAL_CREDITOS  WHERE ID_CUENTA = VAR_ACCOUNT_DEBIT;   
    
     -- Credit Account
    UPDATE CUENTA_CONTABLE SET TOTAL_CREDITOS = :NEW.VALOR_ADQUISICION WHERE ID_CUENTA = VAR_ACCOUNT_CREDIT;
